...
def train_resnet_on_criterion50(image_dir):
    ...
    history = model.fit(
        ...
        epochs=10,
        class_weight=class_weights_dict,  # Aggiungi i pesi delle classi qui
        verbose=1
    )
...
train_resnet_on_criterion50('/media/vincydesy/HData_2/Istologico/script elaborazione patch matlab/esperimento 2/criterio_3')
