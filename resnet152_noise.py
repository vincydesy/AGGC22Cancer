...
def train_resnet152_on_criterion(image_dir):
    """Funzione per addestrare una ResNet152 sui dati forniti in image_dir."""
    ...
    # Carica la ResNet152 pre-addestrata senza i layer superiori (top)
...
train_resnet152_on_criterion('/media/vincydesy/HData_2/Istologico/script elaborazione patch matlab/esperimento 2/criterio_3')
