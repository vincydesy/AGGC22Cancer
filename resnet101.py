...
def train_resnet_on_criterion101(image_dir):
    ...
    model_filename = f'trainedResNet101_{criterion_name}.h5'
    model.save(model_filename)

    return model


train_resnet_on_criterion101('/kaggle/input/esperimento-1/criterio_3')
